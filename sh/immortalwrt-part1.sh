...
sed -i 's|src-git packages https://github.com/immortalwrt/packages.git|src-git packages https://github.com/immortalwrt/packages.git;openwrt-23.05|g' feeds.conf.default
